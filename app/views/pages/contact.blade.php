...
@section('head')
    ...
    <title>Welcome to Book Buddy Contact Page</title>
...
@section('parainfo')
<div class="container">
    <blockquote>Why did I create this website?</blockquote>
    <p>As a mother of two children who have immense pleasure in reading books and also an avid reader myself we end up spending money buying the books which is read one time.
        With this website I am hoping we could swap the books within the community so that friends can see your books and rent them as needed.</p>
